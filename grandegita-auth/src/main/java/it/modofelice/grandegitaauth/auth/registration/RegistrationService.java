...
import it.modofelice.grandegitaauth.auth.registration.emailsender.EmailSender;
import it.modofelice.grandegitaauth.auth.registration.token.ConfirmationToken;
import it.modofelice.grandegitaauth.auth.registration.token.ConfirmationTokenService;
import it.modofelice.grandegitaauth.auth.user.User;
import it.modofelice.grandegitaauth.auth.user.UserRole;
import it.modofelice.grandegitaauth.auth.user.UserService;
